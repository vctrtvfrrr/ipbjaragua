...
export const WAVE_MID =
  'M425.89,335.03c-17.9,28.4-62.9,45.1-95.4,49.2-110.4,10.2-212.1-81.1-322.2-34.8,133.1-97,274.2,79.2,417.6-14.4h0Z'

export const WAVE_DEEP = 'M301.49,398.63c-87.3,36.2-197.9-54.3-295.2-28.2,95.2-58,196.3,32.2,295.2,28.2Z'

export const CHURCH_BODY =
  'M144.99,349.93v-100.4l35.6-30c.2-.2.4-.5.4-.8l-.2-64.4h63v64.4c0,.3.1.6.4.8l34.4,29.7v100.7h-133.7.1Z'

export const CHURCH_DOOR =
  'M193.89,338.93v-48.9c0-11.2,7.5-20.6,16.5-26.3l1.6-.6,1.6.6c9.1,5.6,16.5,15,16.5,26.3v48.9h-36.5.3Z'

export const CHURCH_WINDOW = 'M203.09,229.13v-25c0-5.7,3.7-10.6,8.2-13.5l.8-.3.8.3c4.5,2.9,8.2,7.7,8.2,13.5v25h-18,0Z'

export const CHURCH_SPIRE =
