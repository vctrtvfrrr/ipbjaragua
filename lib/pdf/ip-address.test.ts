...
describe('isPublicIpAddress', () => {
  ...
  it.each([['::'], ['::1'], ['fc00::1'], ['fd00::1'], ['fe80::1'], ['ff02::1'], ['2001:db8::1']])(
    'refuses the reserved IPv6 address %s',
    (address) => {
      expect(isPublicIpAddress(address)).toBe(false)
    }
  )

  it('refuses an IPv6 address that carries a private IPv4 destination', () => {
  ...
  it('accepts an IPv6 address that carries a public IPv4 destination', () => {
