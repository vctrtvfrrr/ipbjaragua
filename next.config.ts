...
const nextConfig: NextConfig = {
  ...
  experimental: {
    authInterrupts: true,
    // next/image may load sharp before lib/sharp pins its concurrency, and sharp drops its glibc
    // single-thread default once the production image sets MALLOC_ARENA_MAX.
    imgOptConcurrency: 1,
